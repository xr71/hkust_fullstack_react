...
import { Breadcrumb, BreadcrumbItem, Modal, ModalBody, 
  ModalHeader, ModalFooter, Form, FormGroup, Input, 
  Col, Label
} from 'reactstrap';
...
class CommentForm extends Component {
    ...
    validate(fullname) {
      ...
      if (this.state.touched.fullname && fullname.length < 3) {
          ...
          errors.fullname = 'Your name should be less than or equal to 15 characters'
      }
    }
                    ...
                    <ModalBody>
                      ...
                      <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                        <FormGroup row>
                          ...
                          <Control.select className="form-control col-12" 
                            model=".rating" 
                            id="rating"
                          >
                        ...
                        <FormGroup row>
                          <Label className="col-12" htmlFor="fullname">Your Name</Label>
